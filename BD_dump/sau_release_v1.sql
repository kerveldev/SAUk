...
-- Tiempo de generación: 24-03-2022 a las 17:38:31
...
(140, 15, 'LOGIN', '2022-03-22 16:44:35', 1, 0, 0),
(141, 15, 'LOGIN', '2022-03-22 20:48:44', 1, 0, 0),
(142, 15, 'LOGIN', '2022-03-23 15:09:49', 1, 0, 0),
(143, 15, 'LOGIN', '2022-03-23 19:19:47', 1, 0, 0),
(144, 15, 'LOGIN', '2022-03-24 16:15:26', 1, 0, 0),
(145, 1, 'LOGIN', '2022-03-24 16:18:28', 1, 0, 0),
(146, 1, 'LOGIN', '2022-03-24 16:19:05', 1, 0, 0),
(147, 1, 'LOGIN', '2022-03-24 16:19:51', 1, 0, 0),
(148, 1, 'LOGIN', '2022-03-24 16:19:59', 1, 0, 0),
(149, 1, 'LOGIN', '2022-03-24 16:23:40', 1, 0, 0),
(150, 1, 'LOGIN', '2022-03-24 16:24:02', 1, 0, 0),
(151, 15, 'LOGIN', '2022-03-24 16:25:15', 1, 0, 0);
...
INSERT INTO `links` (`Id_Link`, `Id_Usuario`, `Id_Modulo`, `Id_Fuente`, `Principal`, `Escritura`, `UCrea`, `FCrea`, `UAct`, `FAct`) VALUES
(2, 1, 1, 1, 1, 1, 1, '2022-01-06 16:24:47', NULL, '2022-03-22 16:11:37'),
...
(10, 1, 8, 1, -1, 1, 1, '2022-03-22 14:12:57', NULL, '2022-03-24 15:31:50'),
(11, 1, 7, 1, -1, -1, 1, '2022-03-22 14:13:38', NULL, '2022-03-24 15:31:47'),
(12, 1, 1, 3, 1, 1, 1, '2022-03-22 16:10:20', NULL, '2022-03-22 16:10:20'),
(17, 1, 7, 3, -1, 1, 15, '2022-03-23 19:52:00', 1, '2022-03-24 15:50:02'),
(22, 2, 8, 1, -1, 1, 15, '2022-03-24 16:40:46', NULL, '2022-03-24 16:40:46');
...
(1, 'P', 'm', 'n', 'ni', 0x761b98b34eb8babe02675d505e78892e, 'DEVELOPER', 1, 1, 'e789a05d7a4dde45cf966b644843c95307e3d297', NULL, '2022-01-06 01:35:31', NULL, '2022-03-24 16:24:02'),
...
(15, 'Admin', 'System', 'SAU', 'sau_admin', 0xf48ed05118a8dcf6d5a26abf8d1dc784, 'DEVELOPER', 1, 1, '7321ae14ff39124b3636a7ddec733c2d88b717cb', NULL, '2022-03-17 13:56:30', 1, '2022-03-24 16:25:15');
...
ALTER TABLE `links`
  ...
  ADD UNIQUE KEY `Fuente_Modulo_Usuario` (`Id_Usuario`,`Id_Modulo`,`Id_Fuente`),
...
--
ALTER TABLE `accesos`
  MODIFY `Id_Acceso` bigint(20) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=152;
...
--
ALTER TABLE `links`
  MODIFY `Id_Link` bigint(20) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=23;
...
--
ALTER TABLE `navegantes`
  ADD CONSTRAINT `fk_nivel_navegante` FOREIGN KEY (`Nivel`) REFERENCES `navegantes_niveles` (`Id_UNivel`) ON DELETE NO ACTION ON UPDATE CASCADE;
COMMIT;
