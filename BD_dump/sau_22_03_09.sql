...
-- Tiempo de generación: 09-03-2022 a las 16:41:50
...
(5, 'Dash_admin', '/web/vistas/dash_admin/dash_admin.html', 1, 1, '2022-02-28 14:50:50', 1, '2022-03-04 18:26:40'),
(6, 'Proveedores', '/web/vistas/proveedores/proveedores_lst.html', 10, 1, '2022-02-28 20:48:28', 1, '2022-02-28 20:48:28'),
(7, 'Dash-IPH', '/web/vistas/iph-admin/iph-admin.html', 1, 1, '2022-03-03 20:58:05', 1, '2022-03-04 18:26:54');
...
(2, 'P2', 'm2', 'n2', 'ni2', 0x11561e9a351f92cdfe7744c79d0dcd49, 'SUPERVISOR_CAPTURA', 1, 1, 'ee9dab94c13636bc7cc98672f49a85861c770654', NULL, '2022-01-06 01:35:43', NULL, '2022-03-04 20:09:12'),
...
--
ALTER TABLE `accesos`
  MODIFY `Id_Acceso` bigint(20) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=104;
...
--
ALTER TABLE `modulos`
  MODIFY `Id_Modulo` bigint(20) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=8;
